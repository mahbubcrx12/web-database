...
<input type="hidden" value="" name="couseid">
<fieldset>
...
<div class="form-group">
  ...
  <input  name="ctName" id="ctName" value=""  placeholder="Your Name" class="form-control"  type="text" >
...
<!-- Text input-->
  ...
  <input name="marks" value=""  class="form-control"  type="number" min="1" max="100">
...
<!-- Text input-->
  ...
  <label class="col-md-4 control-label">Question</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
  <input name="numberQuestion" placeholder="Your Last Education Result!" class="form-control" value="" type="text">
    <div class="alert alert-danger slastresult-display-error" style="display: none"></div>
	</div>
  </div><!-- <span class="error"></span> -->
</div>
...
<input name="examDuration" placeholder="##" value="" class="form-control" type="number">
