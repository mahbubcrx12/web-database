...
.title{
	...
	font-size:20px;
	height:50px;
	background:-webkit-linear-gradient(135deg, #495568, #1b61d1)
}
</style>
  <body>
<!-- Static navbar -->
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Student Dashboard <small>Manage Your Account</small></h1>
				</div>
				<div class="col-md-2">
