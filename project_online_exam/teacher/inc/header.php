...
<html lang="en">
  <head>
    ...
    <link href="<?php echo urlhelper::baseurl();?>/student/css/style.css" rel="stylesheet">
 <script src="<?php echo urlhelper::baseurl();?>/js/jquery.js"></script>
	...
	<script src="<?php echo urlhelper::baseurl();?>/teacher/js/coustom.js"></script>
  </head>
...
<!-- Static navbar -->
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="main.html">Teacher</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#">Welcome, <?php echo $_SESSION["sName"]; ?></a></li>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Teacher Dashboard <small>Manage Your Account</small></h1>
				</div>
				<div class="col-md-2">
